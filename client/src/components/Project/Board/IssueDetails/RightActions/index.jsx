...
const ProjectBoardIssueDetailsRightActions = ({
  ...
  const getUserById = userId =>
    projectUsers.find(user => user.id === parseInt(userId));
    ...
    <>
      ...
      <Select
        ...
        renderOption={({ value, ...optionProps }) => (
          <UserOptionCont {...optionProps}>
            {renderUserOption(getUserById(value))}
          </UserOptionCont>
        )}
      />
    </>
  ...
  const renderPriority = () => (
    <>
      ...
      <Select
        ...
        renderOption={({ value, ...optionProps }) => (
          <PriorityOption {...optionProps}>
            {renderPriorityItem(value)}
          </PriorityOption>
        )}
      />
    </>
